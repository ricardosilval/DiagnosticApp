...
import cl.diagnosticapp.model.requests.RolRequest;
import cl.diagnosticapp.model.responses.BaseResponse;
import cl.diagnosticapp.model.responses.RolResponse;
...
public class RolesController {
    ...
    public Response get(@PathParam("id") String id) {
        try {
            ...
            if (rol == null) {
                return Response.status(Response.Status.NOT_FOUND).entity(new PortalResponse(Messages.Errores.OBJECT_NOT_FOUND)).build();
            }
